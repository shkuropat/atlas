...
- [health.proto](#health.proto)
    ...
    - [ServingStatus](#grpc.health.v1.ServingStatus)
...
| ----- | ---- | ----- | ----------- |
| service | [string](#string) |  | Which service to check |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| status | [ServingStatus](#grpc.health.v1.ServingStatus) |  | Whether service is serving requests |
...
<a name="grpc.health.v1.ServingStatus"></a>
