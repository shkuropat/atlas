 ...
 * @const
 */
proto.atlas.ObjectsList.repeatedFields_ = [500,600,700,800,900];
...
proto.atlas.ObjectsList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    object_status_pb.ObjectStatus.toObject, includeInstance),
...
proto.atlas.ObjectsList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 700:
      ...
      break;
    case 800:
      var value = new object_status_pb.ObjectStatus;
      reader.readMessage(value,object_status_pb.ObjectStatus.deserializeBinaryFromReader);
...
proto.atlas.ObjectsList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      800,
      f,
      object_status_pb.ObjectStatus.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.atlas.ObjectStatus>}
 */
proto.atlas.ObjectsList.prototype.getObjectStatusesList = function() {
  return /** @type{!Array<!proto.atlas.ObjectStatus>} */ (
    jspb.Message.getRepeatedWrapperField(this, object_status_pb.ObjectStatus, 800));
};


/**
 * @param {!Array<!proto.atlas.ObjectStatus>} value
 * @return {!proto.atlas.ObjectsList} returns this
*/
proto.atlas.ObjectsList.prototype.setObjectStatusesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 800, value);
};


/**
 * @param {!proto.atlas.ObjectStatus=} opt_value
 * @param {number=} opt_index
 * @return {!proto.atlas.ObjectStatus}
 */
proto.atlas.ObjectsList.prototype.addObjectStatuses = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 800, opt_value, proto.atlas.ObjectStatus, opt_index);
};
 ...
 * @return {!proto.atlas.ObjectsList} returns this
 */
proto.atlas.ObjectsList.prototype.clearObjectStatusesList = function() {
...
proto.atlas.ObjectsList.prototype.getFilesList = function() {
  return /** @type{!Array<!proto.atlas.File>} */ (
    jspb.Message.getRepeatedWrapperField(this, file_pb.File, 900));
};
...
proto.atlas.ObjectsList.prototype.setFilesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 900, value);
};
...
proto.atlas.ObjectsList.prototype.addFiles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 900, opt_value, proto.atlas.File, opt_index);
};
